...
For Jira, use `tracker.kind: jira` with the Jira-specific fields and set `JIRA_EMAIL` / `JIRA_API_TOKEN` as needed. See [`WORKFLOW.md`](./WORKFLOW.md) for this repository's active workflow and [`docs/SPEC.md`](./docs/SPEC.md) for the full workflow/configuration contract.
...
| ------ | --------------------- | ------------------------------------------------------------------ |
| GET    | `/`                   | Lightweight backend status page                                    |
